# ============================================================
#  Bony Endplate Tortuosity — Statistical Analysis
...
setwd("C:/Users/Ahmad Alminnawi/Desktop/pipeline_publication/modeling-part/submitted_version/second submission/media-guidlines-rev/media/prism/tortuosity")
df <- read_excel("tortuosity_R.xlsx", sheet = "Sheet1")

dep_variable <- "Tortuosity"
